...
def _load_predict_helpers():
    ...
    return _parse_args, _write_csv, _write_json


def test_parse_args_single_pdb_mode() -> None:
    """Parse single-PDB mode arguments."""
    _parse_args, _write_csv, _write_json = _load_predict_helpers()
    del _write_csv, _write_json
